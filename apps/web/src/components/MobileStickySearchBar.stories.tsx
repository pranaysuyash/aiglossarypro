...
const meta: Meta<typeof MobileStickySearchBar> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Sticky search bar that appears at bottom of mobile screens and opens full-screen search overlay when tapped',
      },
    },
  },
  decorators: [
          ...
          {Array.from({ length: 20 }, (_, i) => (
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-400 mt-1">
                This is a sample AI/ML term definition that demonstrates how content would appear in
                the app. The sticky search bar should remain visible at the bottom while scrolling
