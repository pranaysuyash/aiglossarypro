...
const meta: Meta<typeof PersonalizedDashboard> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'AI-powered adaptive dashboard with personalized content recommendations, learning paths, and user insights.',
      },
    },
  },
  decorators: [
...
export const Default: Story = {
  parameters: {
    docs: {
      description: {
        story:
          'Default personalized dashboard with user profile, recommendations, and learning paths.',
      },
    },
  },
};
...
export const BeginnerUser: Story = {
                ...
                data: {
                  ...
                  userProfile: {
                    ...
                    interests: [
                      {
                        categoryId: '1',
                        categoryName: 'Machine Learning Basics',
                        interestScore: 78,
                        timeSpent: 1200,
                        recentActivity: 60,
                      },
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Personalized dashboard for a beginner user with basic topics and foundational content.',
      },
    },
  },
};
...
export const ExpertUser: Story = {
                ...
                data: {
                  ...
                  userProfile: {
                    ...
                    interests: [
                      {
                        categoryId: '1',
                        categoryName: 'Advanced Neural Architectures',
                        interestScore: 98,
                        timeSpent: 4800,
                        recentActivity: 180,
                      },
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Personalized dashboard for an expert user with advanced topics and cutting-edge research.',
      },
    },
  },
};
