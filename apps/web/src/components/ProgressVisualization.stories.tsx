...
const meta: Meta<typeof ProgressVisualization> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Progress visualization component showing user learning statistics, achievements, and progress tracking.',
      },
    },
  },
  tags: ['autodocs'],
...
export const ActiveUser: Story = {
  parameters: {
    docs: {
      description: {
        story:
          'Progress visualization for an active user with substantial progress and achievements.',
      },
    },
  },
};
...
export const PowerUser: Story = {
  parameters: {
    docs: {
      description: {
        story:
          'Progress visualization for a power user with high engagement and multiple achievements.',
      },
    },
  },
};
