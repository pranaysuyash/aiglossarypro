...
import { type ContentNode, flattenStructure, getBreadcrumbPath } from '@/types/content-structure';
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center space-x-2">
              ...
              {/* Priority Badge */}
              {node.metadata?.priority === 'high' && <Star className="h-3 w-3 text-yellow-500" />}
            </div>
