      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">Display live preview</p>
          </div>
...
export const Interactive: Story = {
  render: () => {
    ...
    return (
      <div className="space-y-4">
        <div className="flex items-center space-x-2">
          <Switch id="interactive-switch" checked={isEnabled} onCheckedChange={setIsEnabled} />
...
export const AccessibilityExample: Story = {
  render: () => (
    <div className="space-y-4">
      <div className="flex items-center space-x-2">
        <Switch id="screen-reader" aria-describedby="screen-reader-description" />
      ...
      <div className="flex items-center space-x-2">
        <Switch id="high-contrast" aria-describedby="high-contrast-description" />
...
export const CustomStyling: Story = {
  render: () => (
    <div className="space-y-4">
      ...
      <div className="flex items-center space-x-2">
        <Switch className="data-[state=checked]:bg-red-500 data-[state=unchecked]:bg-gray-200" />
        <Label>Red theme</Label>
      </div>

      <div className="flex items-center space-x-2">
        <Switch className="data-[state=checked]:bg-purple-500 data-[state=unchecked]:bg-gray-200" />
        <Label>Purple theme</Label>
      </div>

      <div className="flex items-center space-x-2">
        <Switch className="h-8 w-14 data-[state=checked]:bg-blue-500" />
  ...
  render: () => {
    ...
    return (
      <div className="flex items-center space-x-2">
        ...
        />
        <Label>{isLoading ? 'Saving...' : 'Auto Backup'}</Label>
        {isLoading && (
