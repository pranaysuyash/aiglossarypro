...
export const Default: Story = {
  args: {
    originalDefinition: sampleDefinition,
...
export const WithCustomImprovementTypes: Story = {
  args: {
    originalDefinition: `Deep learning uses neural networks with multiple layers to learn complex patterns in data.`,
