      ...
      <Card className="h-full transition-all duration-200 hover:shadow-lg border border-gray-100 dark:border-gray-800 group cursor-pointer" onClick={handleClick}>
        <CardContent className="p-4 sm:p-6">
          <div className="flex items-start space-x-3 mb-4">
            <div
              className={`w-12 h-12 sm:w-14 sm:h-14 rounded-lg ${colorClass} flex items-center justify-center flex-shrink-0`}
            >
                ...
                {displaySubcategoryCount > 0 && (
                  <div className="flex items-center gap-1">
                    ...
                    <span className="hidden sm:inline">
                      {displaySubcategoryCount} subcategories
                    </span>
            ...
            {showSubcategoryActions && displaySubcategoryCount > 0 && (
              <Link href={`/categories/${category.id}/subcategories`} className="sm:flex-shrink-0">
                <Button
                  variant="ghost"
                  size="sm"
                  className="w-full sm:w-auto flex items-center justify-center gap-1 min-h-[40px]"
                >
