...
const CrossReferenceAnalytics: React.FC<CrossReferenceAnalyticsProps> = ({
  ...
  const hasError =
    metricsQuery.error || flowsQuery.error || pathwaysQuery.error || insightsQuery.error;
      ...
      <Card className={`${className} border-red-200`}>
        <CardContent className="p-6">
          <div className="text-center text-red-600">
            ...
            <Button variant="outline" onClick={analytics.refreshAnalytics} className="mt-2">
    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex gap-2">
          <Select
            value={timeRange}
            onValueChange={(value: string) => setTimeRange(value as '7d' | '30d' | '90d')}
          >
          ...
          <Button variant="outline" onClick={analytics.refreshAnalytics} disabled={isLoading}>
        ...
        <TabsContent value="overview" className="space-y-6">
          ...
          {insightsQuery.data && (
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  {insightsQuery.data.navigationPatterns.map((pattern, _index) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-gray-600">Terms with the highest connectivity scores</p>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-gray-600">Incoming vs outgoing references</p>
              </CardHeader>
              <CardContent>
                {hubTermsData.length > 0 ? (
                  <ResponsiveContainer width="100%" height={300}>
        ...
        <TabsContent value="flows" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <p className="text-sm text-gray-600">Common navigation patterns between terms</p>
            </CardHeader>
            <CardContent>
              {flowsData.length > 0 ? (
                    ...
                    >
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-gray-500 mt-1">
                          {flow.flow} flows • {flow.timeGap}m avg gap • {flow.completion}%
                          completion
                        </div>
                      </div>
                      <div className="flex items-center">
                  ...
                  <ResponsiveContainer width="100%" height={250}>
                    <PieChart>
                      <Pie
                        ...
                        dataKey="value"
                      >
                        {pathwayTypeData.map((_entry, index) => (
