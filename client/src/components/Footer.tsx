    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              <svg
                ...
                className="h-8 w-8 text-primary-300 dark:text-primary-400"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  ...
                  className="text-gray-100 hover:text-white dark:text-gray-50 dark:hover:text-gray-100 transition focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                >
                  Home
                </Link>
              </li>
          ...
          <div>
            <h3 className="text-lg font-medium text-white dark:text-gray-100 mb-4">
              Subscribe to Updates
            </h3>
            <p className="text-sm mb-4 text-gray-100 dark:text-gray-50">
              Get notified when we add new terms or update content.
            </p>
            <form onSubmit={handleSubscribe} className="flex" aria-label="Newsletter subscription">
            ...
            <p id="newsletter-description" className="sr-only">
              Subscribe to receive updates about new AI/ML terms and content
            </p>
          </div>
        </div>
