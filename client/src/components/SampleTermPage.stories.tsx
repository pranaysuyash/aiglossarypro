...
const sampleTerm = {
  ...
  tags: ['Deep Learning', 'Machine Learning', 'AI', 'Pattern Recognition', 'Artificial Intelligence'],
  relatedTerms: [
...
export const BeginnerLevel: Story = {
  args: {
    term: {
      ...
      complexity: 'Beginner',
      definition: 'Artificial Intelligence (AI) refers to computer systems that can perform tasks typically requiring human intelligence, such as learning, reasoning, problem-solving, and understanding language. AI enables machines to mimic cognitive functions and adapt to new situations.',
...
export const AdvancedLevel: Story = {
  args: {
    term: {
      ...
      tags: ['Transformers', 'Self-Attention', 'NLP', 'Deep Learning', 'BERT', 'GPT', 'Sequence Modeling'],
      examples: [
