...
const meta: Meta<typeof SurpriseMe> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Surprise Me component that provides random term discovery with multiple discovery modes and analytics.',
      },
    },
  },
  tags: ['autodocs'],
...
export const WithMultipleModes: Story = {
  parameters: {
    docs: {
      description: {
        story:
          'Surprise Me component showing different discovery modes (Random, Trending, Recommended, etc.).',
      },
    },
  },
};
...
export const WithAnalytics: Story = {
  parameters: {
    docs: {
      description: {
        story:
          'Surprise Me component with analytics panel showing discovery statistics and user engagement.',
      },
    },
  },
};
