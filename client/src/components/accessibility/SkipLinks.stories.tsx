...
const meta: Meta<typeof SkipLinks> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Skip links component that provides keyboard users quick navigation to main content areas. Essential for accessibility.',
      },
    },
  },
  args: {},
...
export const Default: Story = {
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="bg-blue-100 border border-blue-300 rounded-lg p-4 mb-6">
          ...
          <div className="text-sm text-blue-700 space-y-1">
            ...
            <p>
              2. Press <kbd className="px-2 py-1 bg-blue-200 rounded">Tab</kbd> to reveal skip links
            </p>
            <p>3. Use arrow keys or continue tabbing to navigate between skip links</p>
            <p>
              4. Press <kbd className="px-2 py-1 bg-blue-200 rounded">Enter</kbd> to activate a skip
              link
            </p>
          </div>
        </div>
        ...
        <main id="main-content" className="bg-white border rounded p-6">
          ...
          <div className="prose max-w-none">
            ...
            <p className="mb-4">
              ...
              quickly navigate to the main content without having to tab through all the navigation
              elements.
            </p>
            <p className="mb-4">
              The skip links are hidden by default but become visible when focused, typically by
              pressing the Tab key when the page loads.
            </p>
          </div>
        </main>
      </div>
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Default skip links with a mock page layout showing navigation, search, and main content areas.',
      },
    },
  },
};
...
export const FocusDemo: Story = {
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="bg-yellow-100 border border-yellow-300 rounded-lg p-4 mb-6">
          ...
          <p className="text-sm text-yellow-700 mb-3">
            The skip links are currently hidden but will appear when focused. Try tabbing from this
            text to see them appear.
          </p>
        ...
        <nav id="navigation" className="mb-6 p-4 bg-white border rounded">
          ...
          <p className="text-sm text-gray-600 mt-3">
            Without skip links, keyboard users would need to tab through all 16 navigation items to
            reach the main content.
          </p>
        </nav>
        ...
        <main id="main-content" className="bg-white border rounded p-6">
          ...
          <p className="text-gray-700">
            This main content area can be reached directly using the skip links, saving keyboard
            users from tabbing through all the navigation and search elements above.
          </p>
        </main>
      </div>
    </div>
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Demonstrates the utility of skip links with extensive navigation that would be tedious to tab through.',
      },
    },
  },
};
...
export const CustomSkipLinks: Story = {
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="bg-green-100 border border-green-300 rounded-lg p-4 mb-6">
            ...
            <p className="text-sm text-green-700">
              This example shows customized skip links with different styling and additional
              targets.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <main id="main-content" className="md:col-span-3 p-6 bg-white border rounded">
              <h1 className="text-2xl font-bold mb-4">Main Content Area</h1>
              <p className="mb-4">
                This layout demonstrates custom skip links that allow users to jump to different
                sections of the page including header, sidebar, main content, and footer.
              </p>
              <p>
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Example of customized skip links with different styling and additional navigation targets.',
      },
    },
  },
};
...
export const MinimalLayout: Story = {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <main id="main-content" className="bg-white border rounded p-6">
          ...
          <p>
            This simple layout still includes skip links to ensure accessibility for all users, even
            when the navigation is minimal.
          </p>
        </main>
      </div>
    </div>
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Skip links in a minimal layout - still important for accessibility even with simple navigation.',
      },
    },
  },
};
...
export const AccessibilityGuideline: Story = {
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="bg-purple-100 border border-purple-300 rounded-lg p-6 mb-6">
          <h2 className="font-semibold text-purple-800 mb-4">
            Skip Links Accessibility Guidelines
          </h2>
        ...
        <main id="main-content" className="bg-white border rounded p-6">
          ...
          <p>
            This component implements WCAG 2.1 guidelines and provides a smooth user experience for
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Documentation example showing accessibility guidelines and best practices for skip links.',
      },
    },
  },
};
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <main id="main-content" className="bg-gray-800 border border-gray-600 rounded p-6">
          ...
          <p className="text-gray-300">
            Skip links maintain proper contrast ratios in dark mode to ensure accessibility for all
            users regardless of their preferred color scheme.
          </p>
        </main>
      </div>
    </div>
