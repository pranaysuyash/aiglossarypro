...
const meta: Meta<typeof AIContentMonitor> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'AI content monitoring dashboard for tracking content quality, user feedback, system performance, and content verification.',
      },
    },
  },
  decorators: [
          ...
          data: [
            {
              ...
              description:
                'The definition seems incomplete and could benefit from more technical detail.',
              severity: 'medium',
              status: 'pending',
            ...
            },
            {
              ...
              description:
                'The explanation is too complex for beginners. Could use simpler language.',
              severity: 'low',
              status: 'reviewed',
            ...
            },
            {
              ...
              description:
                'Missing important applications like medical imaging and drug discovery.',
              severity: 'high',
              status: 'pending',
            ...
            },
            {
              ...
              feedbackType: 'accuracy',
              description:
                'The mathematical formulation contains errors in the Q-learning equation.',
              severity: 'critical',
              status: 'resolved',
        ...
        Promise.resolve({
          data: {
            ...
            timeline: [
              ...
              { date: '2024-01-19', requests: 2234, cost: 78.9, errors: 4 },
                ...
                data: [
                  {
                    ...
                    feedbackType: 'accuracy',
                    description:
                      'Critical error in the fundamental definition. This could mislead users.',
                    severity: 'critical',
                    status: 'pending',
                    createdAt: '2024-01-20T10:30:00Z',
                    updatedAt: '2024-01-20T10:30:00Z',
                  },
                  {
                    ...
                    feedbackType: 'accuracy',
                    description:
                      'Mathematical formula is completely wrong and needs immediate correction.',
                    severity: 'critical',
                    status: 'pending',
                    createdAt: '2024-01-19T14:15:00Z',
