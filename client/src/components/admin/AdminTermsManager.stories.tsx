...
const meta: Meta<typeof AdminTermsManager> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'AI-powered terms management dashboard for admins with content generation, verification, and bulk operations.',
      },
    },
  },
  decorators: [
      ...
      json: () => Promise.resolve({
        data: [
          ...
          },
          {
            ...
            definition: 'Deep Learning uses artificial neural networks with multiple layers to model and understand complex patterns.',
          ...
          },
          {
            ...
            definition: 'Reinforcement Learning is a type of machine learning where an agent learns to make decisions by performing actions in an environment.',
  ...
  if (url.includes('/api/categories')) {
    return Promise.resolve({
      ...
      json: () => Promise.resolve([
        ...
        { id: '2', name: 'Neural Networks', description: 'Artificial neural network architectures' },
        { id: '3', name: 'Learning Paradigms', description: 'Different approaches to machine learning' }
      ])
    });
  }
