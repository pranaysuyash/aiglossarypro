...
const meta: Meta<typeof BulkTermEditor> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Bulk term editor for efficiently editing multiple terms with AI assistance, bulk operations, and batch processing.',
      },
    },
  },
  decorators: [
...
const sampleTerms = [
  ...
  },
  {
    ...
    definition: 'Deep Learning uses artificial neural networks with multiple layers to model complex patterns.',
  ...
  },
  {
    ...
    shortDefinition: 'Learning through interaction with an environment using rewards and penalties.',
    definition: 'Reinforcement Learning is a type of machine learning where an agent learns to make decisions.',
  ...
  },
  {
    ...
    definition: 'Supervised Learning is a type of machine learning where the model learns from labeled examples.',
    category: 'Learning Paradigms',
  ...
  },
  {
    ...
    definition: 'Unsupervised Learning is a type of machine learning that finds patterns in data without labels.',
    category: 'Learning Paradigms',
...
export const WithModifiedTerms: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'BulkTermEditor showing terms with pending modifications, highlighting changed content.',
      },
    },
  },
};
...
export const SingleTerm: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'BulkTermEditor with a single term, showing the interface can handle any number of terms.',
      },
    },
  },
};