...
const meta: Meta<typeof FounderStory> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Founder story section sharing the personal journey and motivation behind creating the AI/ML Glossary Pro platform.',
      },
    },
  },
  decorators: [
      ...
      <div className="bg-white py-16">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">Why I Built This</h2>
            ...
            <div className="flex items-start gap-6">
              ...
              <div>
                <blockquote className="text-lg text-gray-700 italic leading-relaxed mb-4">
                  "As a busy professional, I needed AI/ML knowledge for business decisions but had
                  no time for deep research. So I built what I wished existed - a comprehensive,
                  practical reference that saves time and confusion."
                </blockquote>
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-12">
            <div className="bg-red-50 border border-red-200 p-6 rounded-lg">
              ...
              <p className="text-red-700 text-sm">
                Scattered information, complex explanations, and no time to piece together a
            ...
            <div className="bg-green-50 border border-green-200 p-6 rounded-lg">
              ...
              <p className="text-green-700 text-sm">
                A single, comprehensive resource with practical explanations built by someone who
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="bg-white p-8 rounded-lg shadow-sm border max-w-2xl mx-auto">
            <p className="text-lg text-gray-700 mb-6 italic">
              "I built this because I needed it. As a busy professional, I couldn't find a single
              source for AI/ML concepts that was both comprehensive and practical. So I created what
              I wished existed."
            </p>
