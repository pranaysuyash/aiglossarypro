...
import { ArrowRight, Star, Zap, Clock, Calendar, TrendingUp } from 'lucide-react';
import {
  Dialog,
  DialogContent,
  DialogDescription,
        ...
        <div className="space-y-4">
          ...
          {!isTrialUser && (
            <div className="bg-red-50 rounded-lg p-4 border border-red-100">
              <div className="flex items-center justify-between text-sm text-red-700 mb-2">
                ...
                <span>{viewsUsed} / {dailyLimit} terms</span>
              </div>
          ...
          <div className="grid gap-3">
            <div className="flex items-center gap-3 text-sm">
              ...
              <span><strong>Unlimited access</strong> to 10,000+ AI/ML terms</span>
            </div>
            <div className="flex items-center gap-3 text-sm">
              <div className="flex-shrink-0 w-5 h-5 bg-green-100 rounded-full flex items-center justify-center">
                <Zap className="w-3 h-3 text-green-600" />
              </div>
              <span><strong>Advanced search</strong> with filters and categories</span>
            </div>
            <div className="flex items-center gap-3 text-sm">
              <div className="flex-shrink-0 w-5 h-5 bg-green-100 rounded-full flex items-center justify-center">
                <Star className="w-3 h-3 text-green-600" />
              </div>
              <span><strong>Ad-free experience</strong> and priority support</span>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-lg p-4 text-center border border-green-100">
            ...
            <div className="text-sm text-green-600 font-medium">One-time payment • Lifetime access</div>
