...
export const emptyStateMessages = {
  ...
  terms: {
    ...
    description: "Start exploring AI/ML concepts by browsing categories or searching for specific terms",
  ...
  search: {
    ...
    description: "Try adjusting your search terms or browse categories to discover relevant content",
    action: "Browse Categories",
  },
...
export const confirmationMessages = {
  delete: {
    term: (name: string) => `Are you sure you want to delete "${name}"? This action cannot be undone.`,
