...
import { ArrowRight, BookOpen, Brain, Code, Zap, Users, TrendingUp, Search, Sparkles, Clock } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-100 mb-8 max-w-3xl mx-auto">
              Join 10,000+ professionals mastering AI with our comprehensive glossary.
              From neural networks to transformers - all explained with code examples.
            </p>
      ...
      <section className="py-20 bg-white" id="preview">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <Badge className="mb-4 px-4 py-1 bg-green-100 text-green-800">
              Free Preview
            </Badge>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {sampleTermsPreview.map((term, index) => (
              <Card key={index} className="border-2 border-gray-200 hover:border-purple-500 transition-colors cursor-pointer"
                    onClick={handleSampleCTA}>
                <CardHeader>
...
const testimonials = [
  ...
  },
  {
    ...
    quote: "Finally, a resource that explains complex AI concepts in a way that actually makes sense."
  },
  {
...
const sampleTermsPreview = [
  {
    ...
    preview: "A computational model inspired by biological neural networks, consisting of interconnected layers of nodes that process and transform data..."
  },
  {
    title: "Transformer",
    category: "Architecture",
    preview: "A revolutionary neural network architecture that uses self-attention mechanisms to process sequential data in parallel..."
  },
  {
    title: "Gradient Descent",
    category: "Optimization",
    preview: "An iterative optimization algorithm used to minimize loss functions by moving in the direction of steepest descent..."
  },
  {
    title: "Backpropagation",
    category: "Training",
    preview: "The fundamental algorithm for training neural networks by computing gradients through the chain rule..."
  },
  {
    title: "Attention Mechanism",
    category: "NLP",
    preview: "A technique that allows models to focus on relevant parts of the input when producing outputs..."
  },
  {
    title: "Convolutional Layer",
    category: "Computer Vision",
    preview: "A specialized neural network layer that applies learnable filters to detect features in spatial data..."
  }
];
...
const features = [
  {
    ...
    description: "Comprehensive coverage of every AI/ML concept from basics to cutting-edge research."
  },
  {
    icon: Code,
    title: "Code Examples",
    description: "Real implementation examples in Python, TensorFlow, and PyTorch for every concept."
  },
  {
    icon: TrendingUp,
