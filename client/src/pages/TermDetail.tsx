...
import { SEOMeta, StructuredData } from '@/components/SEO/StructuredData';
  ...
  return (
    <>
      ...
      <SEOMeta
        ...
        keywords={
          term.tags || [term.name, 'AI', 'ML', 'artificial intelligence', 'machine learning']
        }
      ...
      {/* Structured Data */}
      <StructuredData term={term} type="term" />
