...
const meta: Meta<typeof AdminContactsDashboard> = {
  ...
  component: AdminContactsDashboard,
  decorators: [
    (Story) => (
...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Default AdminContactsDashboard component state.'
      }
    }
  }
};
...
export const Loading: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'AdminContactsDashboard in loading state.'
      }
    }
  }
};
...
export const Error: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'AdminContactsDashboard displaying error state.'
      }
    }
  }
};
...
export const WithPermissions: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'AdminContactsDashboard with full admin permissions.'
      }
    }
  }
};
