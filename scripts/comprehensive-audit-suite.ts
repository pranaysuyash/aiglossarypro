...
class ComprehensiveAuditSuite {
  ...
  private async runVisualAudit(): Promise<AuditResult> {
    ...
    try {
      ...
      try {
        ...
        console.log(`    Warning: Could not read comprehensive audit JSON report: ${error.message}`);
      }
  ...
  private parseComprehensiveVisualResults(output: string): { total: number; passed: number; failed: number; warnings: number; details?: any[] } {
