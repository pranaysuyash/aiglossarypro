...
import { modelContentVersions, enhancedTerms } from '../shared/enhancedSchema';
...
async function finalSystemTest() {
  ...
  try {
    ...
    const modelStats = allVersions.reduce((acc, version) => {
    ...
    await db.delete(modelContentVersions)
      .where(eq(modelContentVersions.sectionName, 'quick_test'));
