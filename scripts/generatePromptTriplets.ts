...
import { ALL_295_COLUMNS, ColumnDefinition } from '../shared/all295ColumnDefinitions';
import { ALL_295_PROMPT_TRIPLETS, PromptTriplet } from '../server/prompts/all295PromptTriplets';
...
function generatePromptTriplet(column: ColumnDefinition): PromptTriplet {
...
const allPromptTriplets: PromptTriplet[] = [];
