      ...
      const securityChecks = [
        ...
        },
        {
          ...
          check: () => {
            ...
            return this.config.environment === 'production' ? dbUrl.includes('sslmode=require') : true;
          },
...
async function runProductionDeployment() {
  ...
  const environment = (args.find(arg => arg.startsWith('--env='))?.split('=')[1] || 'development') as 'development' | 'staging' | 'production';
