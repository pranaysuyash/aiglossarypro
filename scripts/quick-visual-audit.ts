...
async function quickVisualAudit() {
  ...
  try {
    ...
    await page.goto('http://localhost:5173/term/8b5bff9a-afb7-4691-a58e-adc2bf94f941', { timeout: 10000 });
    await page.waitForSelector('h1', { timeout: 5000 });
    ...
    await page.goto('http://localhost:5173/category/79f3d163-dae1-499d-8371-047accbe70e9', { timeout: 10000 });
    await page.waitForSelector('h1', { timeout: 5000 });
