...
class NavigationPerformanceTester {
  ...
  async runAllTests(): Promise<PerformanceReport> {
    ...
    await this.runTest('Search Performance Stress Test', { sections: 42, totalNodes: 295, maxDepth: 4 });
...
export { NavigationPerformanceTester, PerformanceReport, TestResult };