...
const LEARNING_PATH_TEMPLATES: LearningPathTemplate[] = [
  {
    ...
    description:
      "A comprehensive introduction to Artificial Intelligence for absolute beginners. Learn the core concepts, terminology, and applications of AI in today's world.",
  ...
  },
  {
    ...
    description:
      'Master the art of deep learning with hands-on projects. Build neural networks from scratch and implement state-of-the-art architectures.',
  ...
  },
  {
    ...
    description:
      'Explore the fascinating world of NLP from basic text processing to advanced language models. Build chatbots, sentiment analyzers, and more.',
  ...
  },
  {
    ...
    description:
      'From pixels to perception - learn how to build computer vision systems that can see and understand the visual world.',
    difficulty_level: 'intermediate',
  ...
  },
  {
    ...
    description:
      'Master the art of teaching machines to make decisions through trial and error. Build game-playing agents and autonomous systems.',
    difficulty_level: 'advanced',
  ...
  },
  {
    ...
    description:
      'A practical guide to machine learning focused on real-world data science applications. Learn to build, evaluate, and deploy ML models.',
    difficulty_level: 'intermediate',
  ...
  },
  {
    ...
    description:
      'Explore the critical ethical considerations in AI development. Learn to build fair, transparent, and accountable AI systems.',
    difficulty_level: 'beginner',
  ...
  },
  {
    ...
    description:
      'Dive into the world of generative AI. Learn to work with and build systems that can create text, images, and more.',
    difficulty_level: 'intermediate',
