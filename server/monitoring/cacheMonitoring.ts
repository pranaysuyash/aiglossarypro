...
import { queryCache, searchCache, userCache, getCacheStats } from '../middleware/queryCache';
import { metricsCollector, CacheHealthStatus } from '../cache/CacheMetrics';
import { db } from '../db';
  ...
  private async checkCacheEfficiency(): Promise<CacheHealthCheck> {
    ...
    if (efficiency < this.THRESHOLDS.MIN_CACHE_EFFICIENCY) {
      return {
        ...
        details: { efficiency, hitRate, evictionRate, threshold: this.THRESHOLDS.MIN_CACHE_EFFICIENCY }
      };
    }
