...
export function registerCrossReferenceRoutes(app: Express): void {
   ...
   */
  app.get(
    '/api/cross-reference/term/:termId',
    adminMiddleware,
    validateParamsMiddleware(termIdParamSchema),
    asyncHandler(async (req: Request, res: Response) => {
   ...
   */
  app.put(
    '/api/cross-reference/term/:termId/update-links',
    requireAdmin,
    validateParamsMiddleware(termIdParamSchema),
    asyncHandler(async (req: Request, res: Response) => {
      const { termId } = req.params;
   ...
   */
  app.post(
    '/api/cross-reference/bulk-process',
    requireAdmin,
    validateBody(bulkProcessSchema),
    asyncHandler(async (req: Request, res: Response) => {
      ...
      try {
        ...
        const summary = {
          ...
          totalLinksAdded: Array.from(results.values()).reduce(
   ...
   */
  app.post(
    '/api/cross-reference/initialize-cache',
    requireAdmin,
    asyncHandler(async (req: Request, res: Response) => {
      try {
  ...
  app.get(
    ...
    asyncHandler(async (req: Request, res: Response) => {
      try {
        ...
        const metrics = await crossReferenceAnalyticsService.analyzeCrossReferences(
          validatedQuery.termIds
        );
  ...
  app.get(
    ...
    asyncHandler(async (req: Request, res: Response) => {
      try {
        ...
        const flows = await crossReferenceAnalyticsService.analyzeReferenceFlows(
  ...
  app.get(
    ...
    asyncHandler(async (req: Request, res: Response) => {
      try {
        ...
        const pathways = await crossReferenceAnalyticsService.discoverLearningPathways(
          validatedQuery.minFrequency
        );
