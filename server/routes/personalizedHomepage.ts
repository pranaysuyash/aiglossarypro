...
export function registerPersonalizedHomepageRoutes(app: Express): void {
   ...
   */
  app.get('/api/personalized/homepage', multiAuthMiddleware, async (req: Request, res: Response) => {
    try {
   ...
   */
  app.post('/api/personalized/profile/regenerate', multiAuthMiddleware, async (req: Request, res: Response) => {
    try {
      const user = (req as any).user;
   ...
   */
  app.get('/api/personalized/recommendations', multiAuthMiddleware, async (req: Request, res: Response) => {
    try {
      const user = (req as any).user;
   ...
   */
  app.put('/api/personalized/preferences', multiAuthMiddleware, async (req: Request, res: Response) => {
    try {
      const user = (req as any).user;
      const { 
        preferredCategories, 
   ...
   */
  app.post('/api/personalized/feedback', multiAuthMiddleware, async (req: Request, res: Response) => {
    try {
      const user = (req as any).user;
      const { 
        recommendationId, 
