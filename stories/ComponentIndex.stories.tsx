...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'AI Glossary Pro Component Library - Comprehensive documentation and testing for all components.',
      },
      page: () => (
...
export const ComponentLibraryIndex: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Complete overview of the AI Glossary Pro component library with organized categories, testing strategies, and usage guidelines.',
      },
    },
  },
};
