      ...
      page: () => (
        <div className="p-8 max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <ul className="text-sm text-gray-600 ml-4 list-disc">
                        <li><strong>Header</strong> - Main application header with search and navigation</li>
                        <li><strong>Footer</strong> - Application footer with links and information</li>
                        <li><strong>Sidebar</strong> - Navigation sidebar for categories and filters</li>
                      </ul>
                    </div>
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-gray-600 ml-4 list-disc">
                        <li><strong>EnhancedTermCard</strong> - Advanced term cards with rich metadata</li>
                        <li><strong>TermCard</strong> - Basic term display cards</li>
                        <li><strong>CategoryCard</strong> - Category overview cards with term counts</li>
                        <li><strong>VirtualizedTermList</strong> - Performance-optimized term lists</li>
                      </ul>
                    </div>
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-gray-600 ml-4 list-disc">
                        <li><strong>SearchBar</strong> - Intelligent search with autocomplete</li>
                        <li><strong>AdvancedSearch</strong> - Detailed search with filters</li>
                        <li><strong>AISemanticSearch</strong> - AI-powered semantic search</li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <ul className="text-sm text-gray-600 ml-4 list-disc">
                        <li><strong>Input</strong> - Text inputs with validation states</li>
                        <li><strong>Button</strong> - Buttons with multiple variants and states</li>
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-gray-600 ml-4 list-disc">
                        ...
                        <li><strong>Dialog</strong> - Modal dialogs and overlays</li>
                      </ul>
                    </div>
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-gray-600 ml-4 list-disc">
                        <li><strong>Alert</strong> - Status messages and notifications</li>
                        <li><strong>Toast</strong> - Temporary notifications</li>
              ...
              <div className="bg-green-50 p-6 rounded-lg">
                <div className="grid md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">All components support both light and dark themes with consistent styling.</p>
                  </div>
                  <div>
                    <h4 className="font-medium text-gray-800 mb-2">Responsive Design</h4>
                    <p className="text-sm text-gray-600">Optimized for Mobile (320px+), Tablet (768px+), and Desktop (1024px+).</p>
                  </div>
                  <div>
                    <h4 className="font-medium text-gray-800 mb-2">Accessibility</h4>
                    <p className="text-sm text-gray-600">WCAG 2.1 AA compliance with keyboard navigation and screen reader support.</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="bg-purple-50 p-6 rounded-lg">
                <h4 className="font-medium text-gray-800 mb-3">Each component includes stories for:</h4>
                <div className="grid md:grid-cols-2 gap-4">
                  <ul className="text-sm text-gray-600 space-y-1">
                    <li>✅ <strong>Default State</strong> - Standard component appearance</li>
                    <li>✅ <strong>Variants</strong> - Different visual styles and configurations</li>
                    <li>✅ <strong>States</strong> - Loading, error, disabled, focused states</li>
                    <li>✅ <strong>Data Scenarios</strong> - Empty, populated, edge cases</li>
                  </ul>
                  <ul className="text-sm text-gray-600 space-y-1">
                    <li>✅ <strong>Responsive</strong> - Mobile, tablet, desktop views</li>
                    <li>✅ <strong>Dark Mode</strong> - Theme variations</li>
                    <li>✅ <strong>Interactive</strong> - User interaction scenarios</li>
                    <li>✅ <strong>Accessibility</strong> - Focus and keyboard navigation</li>
                  </ul>
                </div>
              </div>
            </section>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <ol className="text-sm text-gray-600 space-y-1 list-decimal ml-4">
                      <li><strong>Browse Components</strong> - Explore the component library</li>
                      <li><strong>View Stories</strong> - See components in different states</li>
                      <li><strong>Check Code</strong> - View implementation details</li>
                      <li><strong>Test Interactions</strong> - Try interactive features</li>
                      <li><strong>Copy Examples</strong> - Use code snippets in your work</li>
                    </ol>
                  </div>
                  <div>
            ...
            <section className="text-center">
              <div className="bg-blue-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-blue-800 mb-2">📊 Implementation Status</h3>
          ...
          <footer className="mt-12 pt-8 border-t border-gray-200 text-center text-sm text-gray-500">
            <p>This component library is continuously updated with new components and improvements. 
            Check back regularly for the latest additions and enhancements.</p>
          </footer>
        </div>
      ),
    },
...
export const ComponentLibraryIndex: Story = {
