...
const TestWrapper = ({ children }) => {
    ...
    return (_jsx(QueryClientProvider, { client: queryClient, children: _jsx(Router, { children: children }) }));
};
describe('TermCard Component', () => {
    ...
    describe('Basic Rendering', () => {
        it('renders term card with basic information', () => {
            render(_jsx(TestWrapper, { children: _jsx(TermCard, { term: mockTerm }) }));
        ...
        it('handles missing optional fields gracefully', () => {
            ...
            render(_jsx(TestWrapper, { children: _jsx(TermCard, { term: minimalTerm }) }));
    ...
    describe('Interactive Features', () => {
        it('renders favorite state correctly', () => {
            ...
            render(_jsx(TestWrapper, { children: _jsx(TermCard, { term: favoriteTerm }) }));
        ...
        it('handles favorite toggle interaction', async () => {
            ...
            render(_jsx(TestWrapper, { children: _jsx(TermCard, { term: mockTerm, onFavoriteToggle: onFavoriteToggle }) }));
        ...
        it('renders learned state correctly', () => {
            ...
            render(_jsx(TestWrapper, { children: _jsx(TermCard, { term: learnedTerm }) }));
    ...
    describe('Error Handling', () => {
        ...
        it('handles malformed term data', () => {
            ...
            expect(() => {
                render(_jsx(TestWrapper, { children: _jsx(TermCard, { term: malformedTerm }) }));
            }).not.toThrow();
        });
    });
    ...
    describe('Visual Snapshots', () => {
        it('matches visual snapshot', () => {
            const { container } = render(_jsx(TestWrapper, { children: _jsx(TermCard, { term: mockTerm }) }));
        ...
        it('matches visual snapshot with favorite and learned states', () => {
            ...
            const { container } = render(_jsx(TestWrapper, { children: _jsx(TermCard, { term: stateTerm }) }));
            expect(container.firstChild).toMatchSnapshot();
        });
    });
});
