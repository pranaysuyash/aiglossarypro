...
describe('Accessibility Components', () => {
    ...
    describe('LiveRegion', () => {
        it('renders with correct ARIA attributes', () => {
            render(_jsx(LiveRegion, { message: "Test message", level: "polite" }));
    ...
    describe('FormErrorLiveRegion', () => {
        ...
        it('updates message when prop changes', () => {
            const { rerender } = render(_jsx(FormErrorLiveRegion, { message: "First error" }));
            let errorRegion = screen.getByRole('alert', { hidden: true });
            expect(errorRegion).toHaveTextContent('First error');
            rerender(_jsx(FormErrorLiveRegion, { message: "Second error" }));
    ...
    describe('KeyboardNavigation', () => {
        it('renders with correct role and ARIA attributes', () => {
            render(_jsxs(KeyboardNavigation, { ariaLabel: "Test navigation", children: [_jsx("button", { children: "Item 1" }), _jsx("button", { children: "Item 2" }), _jsx("button", { children: "Item 3" })] }));
            const navigation = screen.getByRole('group', { name: /test navigation/i });
            expect(navigation).toBeInTheDocument();
        });
        it('manages tabindex for keyboard navigation', () => {
            render(_jsxs(KeyboardNavigation, { children: [_jsx("button", { children: "Item 1" }), _jsx("button", { children: "Item 2" }), _jsx("button", { children: "Item 3" })] }));
        ...
        it('handles arrow key navigation', () => {
            ...
            render(_jsxs(KeyboardNavigation, { onNavigate: onNavigate, children: [_jsx("button", { children: "Item 1" }), _jsx("button", { children: "Item 2" }), _jsx("button", { children: "Item 3" })] }));
    ...
    describe('useLiveRegion hook', () => {
        function TestComponent() {
            ...
            return (_jsxs("div", { children: [_jsx("button", { onClick: () => announce('Test message'), children: "Announce" }), _jsx("button", { onClick: () => announceError('Error message'), children: "Announce Error" }), _jsx("button", { onClick: () => announceSuccess('Success message'), children: "Announce Success" }), _jsx(LiveRegion, {})] }));
        }
