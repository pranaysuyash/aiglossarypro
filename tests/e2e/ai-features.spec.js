        ...
        test('should provide intelligent search suggestions', async ({ page }) => {
            ...
            if ((await aiSuggestions.count()) > 0) {
                ...
                if (suggestionCount > 0) {
                    ...
                    const hasIntelligentSuggestions = suggestions.some(s => s.toLowerCase().includes('network') ||
            ...
            for (const section of personalizedSections) {
                if ((await section.count()) > 0) {
                    ...
                    if (count > 0) {
                        ...
                        const hasRelatedContent = recommendationTexts.some(text => text.toLowerCase().includes('machine') ||
