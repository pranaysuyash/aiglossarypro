...
test.describe('Authentication Flows', () => {
    ...
    test.describe('User Registration', () => {
        ...
        test('should prevent registration with existing email', async ({ page }) => {
            ...
            const existingEmailError = await page
                .waitForSelector('text=already exists, text=email taken, [data-testid="email-exists-error"]', { timeout: 5000 })
                .catch(() => null);
    ...
    test.describe('User Login', () => {
        ...
        test('should show error for invalid login credentials', async ({ page }) => {
            ...
            const errorMessage = await page
                .waitForSelector('text=Invalid credentials, text=Login failed, text=incorrect, [data-testid="login-error"]', { timeout: 5000 })
                .catch(() => null);
    ...
    test.describe('Password Reset', () => {
        test('should allow password reset request', async ({ page }) => {
            ...
            const successMessage = await page
                .waitForSelector('text=reset link sent, text=check your email, [data-testid="reset-success"]', { timeout: 5000 })
                .catch(() => null);
    ...
    test.describe('Session Management', () => {
        ...
        test('should maintain session across page refreshes', async ({ page }) => {
            ...
            const stillLoggedIn = (await page.locator('[data-testid="user-menu"], [data-testid="logout-button"]').count()) >
                0;
    ...
    test.describe('Multi-Factor Authentication', () => {
        test('should prompt for MFA when enabled', async ({ page }) => {
            ...
            const mfaPrompt = await page
                .waitForSelector('[data-testid="mfa-input"], input[name="mfa"], input[placeholder*="code"]', { timeout: 5000 })
                .catch(() => null);
            if (mfaPrompt) {
