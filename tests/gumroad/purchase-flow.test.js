...
describe('Purchase Flow Integration Tests', () => {
    ...
    const renderWithProviders = (component) => {
        return render(_jsx(BrowserRouter, { children: _jsx(QueryClientProvider, { client: queryClient, children: component }) }));
    };
    describe('Test Purchase Flow (Development)', () => {
        test('should complete test purchase successfully', async () => {
            ...
            renderWithProviders(_jsx(TestPurchaseButton, {}));
    ...
    describe('Free Tier Gate Component', () => {
        test('should show upgrade prompt for free users', async () => {
            ...
            renderWithProviders(_jsx(FreeTierGate, { user: mockUser, feature: "AI Search", children: _jsx("div", { children: "Premium Content" }) }));
    ...
    describe('Purchase Success Flow', () => {
        test('should display purchase success information', async () => {
            ...
            renderWithProviders(_jsx(PremiumUpgradeSuccess, { ...mockPurchaseData }));
    ...
    describe('Mobile Purchase Flow', () => {
        test('should handle mobile viewport purchase flow', async () => {
            ...
            renderWithProviders(_jsx(FreeTierGate, { user: mockUser, feature: "Mobile Feature", children: _jsx("div", { children: "Mobile Premium Content" }) }));
        ...
        test('should handle touch interactions on mobile', async () => {
            ...
            renderWithProviders(_jsx(FreeTierGate, { user: mockUser, feature: "Touch Feature", children: _jsx("div", { children: "Touch Premium Content" }) }));
            const upgradeButton = screen.getByRole('button', { name: /upgrade now/i });
    ...
    describe('Accessibility Tests', () => {
        test('should be keyboard navigable', async () => {
            ...
            renderWithProviders(_jsx(FreeTierGate, { user: mockUser, feature: "Accessibility Feature", children: _jsx("div", { children: "Accessible Premium Content" }) }));
            const upgradeButton = screen.getByRole('button', { name: /upgrade now/i });
            // Should be focusable
            upgradeButton.focus();
        ...
        test('should have proper ARIA labels', async () => {
            ...
            renderWithProviders(_jsx(FreeTierGate, { user: mockUser, feature: "ARIA Feature", children: _jsx("div", { children: "ARIA Premium Content" }) }));
            const upgradeButton = screen.getByRole('button', { name: /upgrade now/i });
            expect(upgradeButton).toHaveAttribute('aria-label', expect.stringContaining('Upgrade to access ARIA Feature'));
