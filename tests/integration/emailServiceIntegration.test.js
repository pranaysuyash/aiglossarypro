...
import { sendEmail, sendPurchaseInstructionsEmail, sendWelcomeEmail, testEmailConfiguration } from '../../server/utils/email';
import { getPasswordResetEmailTemplate, getPremiumWelcomeEmailTemplate, getWelcomeEmailTemplate } from '../../server/utils/emailTemplates';
describe('Email Service Integration', () => {
    ...
    describe('Email Performance and Monitoring', () => {
        ...
        it('should handle concurrent email sending', async () => {
            ...
            const emailPromises = Array.from({ length: 3 }, (_, i) => sendEmail({
                to: [testEmail],
