...
describe('Firebase Authentication Integration', () => {
    ...
    describe('Firebase Configuration', () => {
        ...
        it('should validate auth domain format', () => {
            ...
            const isValidDomain = authDomain.includes('.firebaseapp.com') ||
        ...
        it('should validate app ID format', () => {
            ...
            const isValidAppId = /^1:\d+:web:[a-f0-9]+$/.test(appId) ||
    ...
    describe('Security Configuration', () => {
        ...
        it('should validate CORS configuration', () => {
            ...
            const isAllowedOrigin = allowedOrigins.some(origin => currentOrigin.startsWith(origin.split('://')[1]) ||
