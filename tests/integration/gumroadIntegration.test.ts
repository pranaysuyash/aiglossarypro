...
describe('Gumroad Payment Integration', () => {
    ...
    beforeAll(() => {
        ...
        registerGumroadRoutes(app as unknown);
    ...
    describe('Gumroad API Integration', () => {
        ...
        it('should handle API rate limiting', async () => {
            ...
            const apiCalls = Array.from({ length: 3 }, () =>
                GumroadService.getSaleDetails('test-sale-id').catch(error => ({ error: error.message }))
            );
    ...
    describe('Error Handling and Resilience', () => {
        ...
        it('should log errors appropriately', async () => {
            ...
            try {
                ...
                await GumroadService.processSaleWebhook({} as unknown);
            } catch (error) {
                // Should log errors
                expect(error).toBeInstanceOf(Error);
            } finally {
