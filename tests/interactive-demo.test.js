...
vi.mock('../client/src/components/interactive/CodeBlock', () => {
    return {
        default: function MockCodeBlock({ title, code, description }) {
            return (_jsxs("div", { "data-testid": "code-block", children: [_jsx("h3", { children: title }), _jsx("code", { children: code }), _jsx("p", { children: description })] }));
        }
    };
});
