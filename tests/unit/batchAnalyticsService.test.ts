...
describe('BatchAnalyticsService', () => {
  ...
  describe('generateUserReport', () => {
    it('should generate comprehensive user analytics report', async () => {
      ...
      (db as any).db.execute.mockResolvedValue([mockUserData]);
  ...
  describe('generateSystemReport', () => {
    it('should generate system-wide analytics report', async () => {
      ...
      (db as any).db.execute.mockResolvedValue([mockSystemData]);
  ...
  describe('getEngagementMetrics', () => {
    it('should calculate engagement metrics', async () => {
      ...
      (db as any).db.execute.mockResolvedValue(mockEngagementData);
  ...
  describe('getConversionFunnel', () => {
    it('should analyze conversion funnel', async () => {
      ...
      (db as any).db.execute.mockResolvedValue([mockFunnelData]);
  ...
  describe('error handling', () => {
    it('should handle database errors gracefully', async () => {
      (db as any).db.insert.mockImplementation(() => {
    ...
    it('should retry failed batches', async () => {
      let attempts = 0;
      (db as any).db.execute.mockImplementation(() => {
        attempts++;
        if (attempts < 3) {
