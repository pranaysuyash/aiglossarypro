...
describe('SupportService', () => {
    ...
    describe('createTicket', () => {
        it('should create a support ticket successfully', async () => {
            ...
            db.db.returning.mockResolvedValue([mockTicket]);
        ...
        it('should validate ticket data', async () => {
            await expect(supportService.createTicket({
                userId: '',
                subject: '',
                description: 'Test',
                category: 'general'
    ...
    describe('updateTicket', () => {
        it('should update ticket status', async () => {
            ...
            db.db.returning.mockResolvedValue([mockUpdatedTicket]);
        ...
        it('should add internal notes to tickets', async () => {
            ...
            db.db.returning.mockResolvedValue([note]);
    ...
    describe('respondToTicket', () => {
        it('should send response to user', async () => {
            ...
            db.db.returning.mockResolvedValue([response]);
        ...
        it('should update ticket status after resolution', async () => {
            ...
            expect(db.db.set).toHaveBeenCalledWith(expect.objectContaining({
                status: 'resolved'
            }));
        });
    });
    describe('getTickets', () => {
        it('should retrieve tickets with filters', async () => {
            ...
            db.db.execute.mockResolvedValue(mockTickets);
        ...
        it('should get user tickets', async () => {
            ...
            db.db.execute.mockResolvedValue(mockUserTickets);
    ...
    describe('getTicketMetrics', () => {
        it('should calculate support metrics', async () => {
            ...
            db.db.execute.mockResolvedValue([mockMetrics]);
        ...
        it('should track ticket trends', async () => {
            ...
            db.db.execute.mockResolvedValue(mockTrends);
    ...
    describe('escalateTicket', () => {
        it('should escalate high-priority unresolved tickets', async () => {
            ...
            db.db.execute.mockResolvedValue([mockTicket]);
            db.db.returning.mockResolvedValue([{
                    ...mockTicket,
                    status: 'escalated',
