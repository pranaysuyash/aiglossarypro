    ...
    async dismissCookieBanner(page) {
        try {
            ...
            const cookieBanner = await page
                .locator('[data-testid="cookie-banner"], .cookie-banner, [role="dialog"]:has-text("cookie")')
                .first();
            if (await cookieBanner.isVisible()) {
                const acceptButton = await page
                    .locator('button:has-text("Accept"), button:has-text("Accept All"), button:has-text("OK")')
                    .first();
