 ...
 */
export const ESSENTIAL_AI_TERMS = {
...
export function searchTerms(query) {
    ...
    return getAllEssentialTerms().filter(term => term.name.toLowerCase().includes(normalizedQuery) ||
