...
class PerformanceDashboard {
    ...
    port;
    updateInterval;
    constructor(port = 3002, updateInterval = 1000) {
        this.port = port;
    ...
    generateAlerts(metrics) {
        ...
        const recentSlowRenders = metrics.filter(m => m.renderTime > 100 && now - m.timestamp < 60000 // Last minute
        );
        ...
        const highMemoryUsage = metrics.filter(m => m.memoryUsage > 100 && now - m.timestamp < 300000 // Last 5 minutes
        );
