...
async function quickTest() {
    ...
    try {
        ...
        const hasContentNavigation = (await page.locator('h2:has-text("Content Navigation")').count()) > 0;
        console.log(`📋 Content Navigation section: ${hasContentNavigation ? '✅ Found' : '❌ Not found'}`);
        // Check for hierarchical navigator component
        const hasNavigatorCard = (await page.locator('[data-testid="card"]').count()) > 0;
        console.log(`🗂️ Hierarchical Navigator component: ${hasNavigatorCard ? '✅ Found' : '❌ Not found'}`);
        ...
        console.log(`🌳 Tree/Flat toggle: ${hasTreeButton || hasFlatButton ? '✅ Found' : '❌ Not found'}`);
        ...
        if (hasSectionsTab) {
            ...
            console.log(`🗂️ Navigation in sections tab: ${hasNavInSections ? '✅ Found' : '❌ Not found'}`);
        }
