...
async function testManualLogin() {
  ...
  try {
    ...
    console.log(
      chalk.green(
        `Form populated - Email: ${emailValue}, Password: ${passwordValue ? 'filled' : 'empty'}`
      )
    );
    ...
    console.log(
      chalk.blue('Test complete. Browser will stay open for 30 seconds for manual inspection...')
    );
