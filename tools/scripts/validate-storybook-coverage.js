...
class StorybookCoverageValidator {
    ...
    batchSize = 50; // Process components in batches
    constructor() {
    ...
    extractStoryComponentName(storyPath) {
    ...
    async generateMissingStories(missingComponents) {
...
export { StorybookCoverageValidator };
